...
public class Projectile : MonoBehaviour {
	...
	private void Update() {
		// It is good practice to multiply transform.Translate parameters by Time.deltaTime to ensure that movement is on a per-second basis and not a per-frame one.
		// I then multiply by 60 because (ideally) this function is called 60 times a second (60FPS).
		tm.Translate(transform.right * speed * facing * Time.deltaTime * 60); 
	}
